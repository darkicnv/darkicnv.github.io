...
export const FRIENDS: Friend[] = [
  { 
    ...
    fullMessage: "Happy Birthday Mou! 🎂 May your day be filled with as much happiness as you bring to everyone around you. Let's make more amazing memories this year!"
  },
  { 
    id: 'rohan', 
    name: "Rohan", 
